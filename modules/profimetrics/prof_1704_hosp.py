...
def get_prof_1704_hosp():
    sqlstr = """select batch_id,error_ind||' - '||(SELECT rv_meaning FROM CG_REF_CODES WHERE RV_DOMAIN = 'PROF_ERROR' and rv_low_value = a.error_ind) error_ind,offer_id,store_id,pz_group_id,origin_id,record_status,create_user_id,create_datetime,last_update_user_id,last_update_datetime
                from
                prof_1704_hosp a
